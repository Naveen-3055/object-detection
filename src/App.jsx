...
function App() {
  ...
  const startCamera = async () => {
    ...
    try {
      // access the camera using the web API
            ...
            contents: [
              {
                parts: [
                  {
                    text:
                      "This is a photo taken from a room camera. Identify the main object  clearly. Describe what it is and its basic use in simple English with 2 or 3 sentences. "
                  },
                  {
                    inline_data: {
